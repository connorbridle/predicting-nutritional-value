...
\section{Method}
	\subsection{The base classification problem}
		...
		\subparagraph{Hard-coded set of rules}
	...
	\subsection{Design}
		...
		\subparagraph{Rule-set design}
		\subparagraph{Investigation into the applicability of current OCR readers available on the marketplace}
	\subsection{Implementation}
		\subparagraph{Implementing the client side application}
		\subparagraph{Implementation of a rule-set that}
